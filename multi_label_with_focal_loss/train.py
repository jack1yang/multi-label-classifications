...
def main(args):
    ...
    model = EncoderCNN_singleimage_lateral(args.num_classes)
    ...
    # mult_label loss
    #bce_loss = nn.BCELoss()
    focal_loss = FocalLoss(args.focal_alpha, args.focal_gamma)
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        for i, (images, image_name, image_labels) in enumerate(data_loader):
            ...
            loss = focal_loss(outputs, image_labels)
            loss.backward()
