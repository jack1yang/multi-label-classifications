...
if __name__ == '__main__':
    ...
    parser.add_argument( '--pretrained', type=str, default='/media/mdisk/ysk/frontal_pretrained_224/Resnet_single_image-35.pkl', help='start from checkpoint or scratch' )
